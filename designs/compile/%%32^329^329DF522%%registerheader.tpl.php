<?php /* Smarty version 2.6.26, created on 2024-02-02 13:27:39
         compiled from registerheader.tpl */ ?>
          ...
          <nav class="nav-menu mobile-menu">
            <ul>
              ...
              <li>
                <a href="#">Signup </a>
                <ul class="dropdown">
                  <li><a href="registration.php">Shop</a></li>
                  <li><a href="customer.php">Customer</a></li>
                  <li><a href="delregister.php">Delivery</a></li>
                </ul>
              </li>
