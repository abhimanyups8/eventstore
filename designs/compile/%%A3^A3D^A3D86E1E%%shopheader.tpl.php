<?php /* Smarty version 2.6.26, created on 2024-02-02 13:27:28
         compiled from shopheader.tpl */ ?>
        ...
        <div class="container">
          ...
          <nav class="nav-menu mobile-menu">
            <ul>
              ...
              <li><a href="shopupdate.php">Profile</a></li>

              <li>
                <a href="#">Orders </a>
                <ul class="dropdown">
                  <li><a href="deliverynormview.php">Delivery Boys</a></li>
              ...
              <li>
                <a href="#">Products </a>
                <ul class="dropdown">
                  <li><a href="productsupdate.php">Add Product</a></li>
