<?php /* Smarty version 2.6.26, created on 2023-10-16 11:09:38
         compiled from delregister.tpl */ ?>
<html>
    ...
    <center>
        <form method="post" action="" enctype="multipart/form-data">
          <table>
           ...
           <tr><td>Delivery Boy Name</td><td><input type="text" name="delname" class="form-control"></td></tr>
           <tr><td>Delivery Boy Address</td><td><textarea name="address" class="form-control"></textarea></td></tr>
           <tr><td>Pincode</td><td><input type="text" name="pincode" class="form-control"></td></tr>
           <tr><td><label>District</label></td><td>
             <select name="district" class="form-control"><option></option>
           ...
           <tr><td> City </td><td><input type="text" name="city" class="form-control"></td></tr>
            <tr><td> Contact number </td><td><input type="text" name="contactno" class="form-control"></td></tr>
