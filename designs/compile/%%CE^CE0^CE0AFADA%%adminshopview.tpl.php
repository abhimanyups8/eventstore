<?php /* Smarty version 2.6.26, created on 2023-10-17 09:11:44
         compiled from adminshopview.tpl */ ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="admincustomerview.php">Customer Details</a>
          </div>
        </div>
      </li> -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="adminshopview.php" data-toggle="collapse" data-target="#collapseTable" aria-expanded="true"
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="admincustomerview.php">Customers</a>
            <a class="collapse-item" href="adminshopview.php">Shops</a>
            <a class="collapse-item" href="complaintview.php">Complaints</a>
                        <a class="collapse-item" href="adminfeedview.php">feedback</a>
            <a class="collapse-item" href="admindelview.php">Delivery Boys</a>
...
" height="200px" width="150px"></td>
                            ...
                            <?php if ($this->_tpl_vars['d']['status'] == 1): ?>
                              <td><b>Approved</b></td>
                      <td><a href="rejected.php?key=<?php echo $this->_tpl_vars['d']['lkey']; ?>
" class="btn btn-danger">Reject</a></td>
                       <?php elseif ($this->_tpl_vars['d']['status'] == 2): ?> <td><a href="approvel.php?key=<?php echo $this->_tpl_vars['d']['lkey']; ?>
" class="btn btn-success">Approve</a></td>
                        <td><b>Rejected</b></td>
                            <?php else: ?>
                    <td><a href="approvel.php?key=<?php echo $this->_tpl_vars['d']['lkey']; ?>
" class="btn btn-success">Approve</a></td>
                   <td><a href="rejected.php?key=<?php echo $this->_tpl_vars['d']['lkey']; ?>
"
                      class="btn btn-danger">Reject</a></td>
